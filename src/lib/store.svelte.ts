...
const STORAGE_KEY = 'tutoring-students-v2';
...
const INITIAL: Student[] = [
	...
	blank({
		id: 'maddie-henderson',
		name: 'Maddie Henderson',
		grade: 11,
		school: 'Bullis',
		schoolUrl: 'https://bullis.instructure.com/?login_success=1',
		username: 'madeline_henderson@bullis.org',
		password: 'Blue77012!',
		days: ['Sunday'],
	...
	blank({
		...
		grade: 6,
		school: 'DCI',
		schoolUrl: 'https://web.toddleapp.com/',
		username: 'olympia.kilcarr@dcinternationalschool.org',
		password: 'Angel333',
		days: ['Sunday'],
	...
	blank({
		...
		school: 'Burke',
		schoolUrl:
			'https://burkeschool.myschoolapp.com/app?svcId=edu&envId=p-1P26ZieRxka5dSIEOGO9kw&bb_id=1#login',
		username: 'cars270@burkeschool.org',
		password: 'Sylvie11Carter',
		days: ['Sunday', 'Wednesday'],
		color: STUDENT_COLORS[2]
	}),
	blank({
		id: 'eli-setty',
		name: 'Eli Setty',
		grade: 11,
		school: 'Field',
		schoolUrl: 'https://fieldschool.myschoolapp.com/app/student#studentmyday/progress',
		username: 'elisetty27@students.fieldschool.org',
		password: 'blackwolf101',
		days: ['Sunday'],
	...
	blank({
		...
		grade: 11,
		school: 'St. Andrews',
		schoolUrl: 'https://saes.instructure.com/',
		username: 't27engel@saes.org',
		password: 'Abbots30',
		days: ['Sunday'],
		color: STUDENT_COLORS[4]
	}),
	blank({
		id: 'franklin',
		name: 'Franklin',
		grade: 7,
		school: 'St. Patricks',
		schoolUrl: GOOGLE_CLASSROOM,
		username: 'haneyfr@s.stpatsdc.org',
		password: 'tiger447',
		days: ['Sunday'],
		color: STUDENT_COLORS[5]
	}),
	// ── Monday ───────────────────────────────────────────────────
	blank({
		id: 'lavinia',
		...
		grade: 6,
		school: 'Maret',
		schoolUrl: 'https://maret.instructure.com/',
		username: 'lavinial2032@maret.org',
		password: 'mLL^^dingo',
		days: ['Monday'],
		color: STUDENT_COLORS[6]
	}),
	blank({
		id: 'devon',
		name: 'Devon',
		grade: 6,
		school: 'St. Patricks',
		schoolUrl: ST_PATS_URL,
		username: 'myersd@s.stpatsdc.org',
		password: 'truth2459',
		days: ['Monday'],
		color: STUDENT_COLORS[7]
	}),
	blank({
		id: 'kira',
		name: 'Kira',
		...
		school: 'St. Patricks',
		schoolUrl: ST_PATS_URL,
		username: 'myersk@s.stpatsdc.org',
		password: 'truth3223',
		days: ['Monday'],
		color: STUDENT_COLORS[8]
	}),
	blank({
		id: 'spencer-duncan',
		name: 'Spencer Duncan',
	...
	blank({
		...
		schoolUrl: 'https://sfs.instructure.com/login/saml',
		username: 'sberman29@sidwell.edu',
		password: 'plkplkS45!',
		days: ['Monday'],
		color: STUDENT_COLORS[10]
	}),
	// ── Tuesday ──────────────────────────────────────────────────
	blank({
		id: 'oliver-lisle',
		...
		username: '20076210@students.k12.dc.us',
		password: 'Dc091713',
		days: ['Tuesday'],
		color: STUDENT_COLORS[11]
	}),
	blank({
		id: 'pari',
		name: 'Pari',
		...
		schoolUrl: BS_URL,
		username: '26pols@bsdc.org',
		password: 'password',
		days: ['Tuesday'],
		color: STUDENT_COLORS[12]
	}),
	blank({
		id: 'lizzie',
		name: 'Lizzie',
		...
		school: 'Blessed Sacrament',
		schoolUrl: BS_URL,
		username: '26erig@bsdc.org',
		password: 'ramenmybirthday',
		days: ['Tuesday'],
		color: STUDENT_COLORS[13]
	}),
	blank({
		id: 'lily',
		name: 'Lily',
		...
		school: 'St. Patricks',
		schoolUrl: GOOGLE_CLASSROOM,
		username: 'bieligkl@s.stpatsdc.org',
		password: 'truth6506',
	...
	blank({
		...
		school: 'St. Patricks',
		schoolUrl: GOOGLE_CLASSROOM,
		username: 'alionblocherno@s.stpatsdc.org',
		password: 'horse391',
		days: ['Tuesday'],
		color: STUDENT_COLORS[1]
	}),
	blank({
		...
		schoolUrl: GOOGLE_CLASSROOM,
		username: 'jdonahue@littleflowerschool.org',
		password: 'jd602252',
		days: ['Tuesday'],
		color: STUDENT_COLORS[2]
	}),
	blank({
		...
		school: 'St. Patricks',
		schoolUrl: ST_PATS_URL,
		username: 'bieligkm@s.stpatsdc.org',
		password: 'truth3223',
		days: ['Tuesday', 'Thursday'],
		color: STUDENT_COLORS[3]
	}),
	...
	blank({
		...
		grade: 3,
		school: 'Key',
		schoolUrl: 'https://keyschooldc.membershiptoolkit.com/',
		username: '',
		password: '',
		days: ['Wednesday'],
		color: STUDENT_COLORS[5]
	...
	blank({
		id: 'campbell-blackford',
		name: 'Campbell Blackford',
		grade: 10,
		school: 'Maret',
		schoolUrl: 'https://maret.instructure.com/',
		username: 'cblackford@maret.org',
		password: 'SweetPea13',
		days: ['Wednesday'],
		color: STUDENT_COLORS[6]
	}),
	blank({
		...
		grade: 9,
		school: 'St. Albans',
		schoolUrl: 'https://stalbansschool.myschoolapp.com/app?svcid=edu#login',
		username: 'JCrawford29@stalbansschool.org',
		password: 'Hockeyplayerong9?!',
		days: ['Wednesday'],
		color: STUDENT_COLORS[7]
	}),
	// ── Thursday ─────────────────────────────────────────────────
	...
	blank({
		...
		school: 'Sidwell Friends',
		schoolUrl: 'https://sfs.instructure.com/login/saml',
		username: 'nberman29@sidwell.edu',
		password: 'plkplk45N',
		days: ['Thursday'],
		color: STUDENT_COLORS[10]
	}),
	...
	blank({
		...
		grade: 7,
		school: 'Landon',
		schoolUrl: 'https://landonschool.instructure.com/login/ldap',
		username: 'zev_thakkar@landon.net',
		password: 'fm3fspqJ',
		days: ['Friday'],
		color: STUDENT_COLORS[11]
	}),
	...
	blank({
		id: 'lauren-chappell',
		name: 'Lauren Chappell',
		grade: 11,
		school: 'St. Andrews',
		schoolUrl: 'https://saes.instructure.com/',
		username: 'l27chapp@saes.org',
		password: 'Swards94',
		days: [],
		color: STUDENT_COLORS[12]
	}),
...
class StudentStore {
	...
	constructor() {
		if (browser) {
			...
			if (raw) {
				try {
					this.list = (JSON.parse(raw) as Record<string, unknown>[]).map(migrate);
				} catch {
					this.list = INITIAL;
				}
			} else {
